...
extern struct lock thread_filesys_lock;

/* Struct that represents a file mapping:
      - contains a variable (used) to state whether an instance of
